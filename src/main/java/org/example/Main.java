...
public class Main {
    public static void main(String[] args) {
        ...
        org.example.UserDAO user = new org.example.UserDAO();
        ...
        while (true) {
            ...
            scanner.nextLine();
                    ...
                    if (opcao == 1) {
                        ...
                        boolean hasUser = user.hasEmail(email);
                        if (hasUser) {
                        ...
                        user.adicionar(new User(nome, email, idade));
                        System.out.println("Usuário cadastrado com sucesso!");

                    } else if (opcao == 2){
                        System.out.println("Usuarios cadastrados: ");
                        user.listar().forEach(System.out::println);

                    } else if (opcao == 3){
                        System.out.println("Digite o nome para busca: ");
                        String busca = scanner.nextLine();
                        var encontrados = user.buscarPorNome(busca);
